...
CREATE OR REPLACE FUNCTION car_app.fn_create_vehicle(
    ...
    p_dual_tank             boolean DEFAULT FALSE,
    p_tank_capacity_l       double precision DEFAULT NULL,
    p_secondary_tank_capacity double precision DEFAULT NULL,
...
CREATE OR REPLACE FUNCTION car_app.fn_update_vehicle(
    ...
    p_secondary_tank_capacity double precision,
...
BEGIN
    ...
    SET
        ...
        dual_tank             = p_dual_tank,
        tank_capacity_l       = p_tank_capacity_l,
        secondary_tank_capacity = p_secondary_tank_capacity,
